    ...
    (() => {
      ...
      class pe {
        constructor(...e) {
          ...
          (i.__swiper__ = !0),
            (i.support = R()),
            (i.device = F({ userAgent: s.userAgent })),
            (i.browser = W()),
            (i.eventsListeners = {}),
      ...
      var De,
        ...
        We = /auto|scroll/,
        Ge = /^tb|vertical/,
        He = /msie|trident/i.test(Re.navigator && Re.navigator.userAgent),
        Ve = function (e) {
        ...
        Ue = function (e, t) {
          ...
          if (qe(e)) return Fe.set(e, Xe), Xe;
          var s = getComputedStyle(e),
            i = Ne(e) && e.ownerSVGElement && e.getBBox(),
            n = !He && "border-box" === s.boxSizing,
            r = Ge.test(s.writingMode || ""),
            o = !i && We.test(s.overflowY || ""),
            a = !i && We.test(s.overflowX || ""),
              ...
              return (
                ...
                setTimeout(function () {
                  t.zoomFromOrigin &&
                    ...
                    t.$inner.empty(),
                    t.lgOpened && t.LGel.trigger(Ht, { instance: t }),
